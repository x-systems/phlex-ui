Feature: Lookup
  ...
  Scenario: Testing lookup in modal
    ...
    Then I select value "Dairy" in lookup "phlex_fp_product__product_category_id"
    Then I select value "Yogourt" in lookup "phlex_fp_product__product_sub_category_id"
  ...
  Scenario: Testing lookup in VirtualPage
    ...
    Then I press menu button "Add Category" using class "phlex-grid-menu"

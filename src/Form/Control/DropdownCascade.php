...
class DropdownCascade extends Dropdown
{
    ...
    /** @var string|Model|null the hasMany/withMany reference model that will generated value for this dropdown list. */
    public $reference;
    ...
    protected function doInitialize(): void
    {
        ...
        $this->cascadeControl->onChange($expr, ['args' => [$this->cascadeControl->elementName => $this->cascadeControl->jsInput()->val()]]);
    }

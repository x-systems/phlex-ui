...
class Lookup extends Input
{
     ...
     * $form->addControl('field', [\Phlex\Ui\Form\Control\Lookup::class, 'settings'=>['allowReselection' => true,
     *                           'selectOnKeydown' => false,
     *                           'onChange'        => new Phlex\Ui\JsExpression('function(value,t,c){
    ...
    protected function applySearchConditions()
    {
        ...
        if ($this->search instanceof \Closure) {
            ...
            $titleKey = $this->titleKey ?: $this->model->titleKey;

            $this->model->addCondition($titleKey, 'like', '%' . $_GET['q'] . '%');
        }
    }

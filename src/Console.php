...
class Console extends View implements \Psr\Log\LoggerInterface
{
     ...
     *   $console->outputHtml()
     *
     * If you are using setModel, and if your model implements \Phlex\Core\DebugTrait,
    ...
    /**
     * Execute method of a certain object. If object uses Phlex\Core\DebugTrait,
     * then debugging will also be used.
     *
     * During the invocation, Console will substitute $webpage->logger with itself,
     * capturing all debug/info/log messages generated by your code and displaying
     * it inside console.
     *
     * // Runs $user_model->generateReport('pdf')
     * Console::addTo($webpage)->runMethod($user_model, 'generateReports', ['pdf']);
     *
     * // Runs PainFactory::lastStaticMethod()
     * Console::addTo($webpage)->runMethod('PainFactory', 'lastStaticMethod');
     *
     * To produce output:

 ...
 *  $modal->addDenyAction('No', new \Phlex\Ui\JsExpression('function(){window.alert("Can\'t do that."); return false;}'));
 *  $modal->addApproveAction('Yes', new \Phlex\Ui\JsExpression('function(){window.alert("You\'re good to go!");}'));
 *

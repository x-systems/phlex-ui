...
// layout
\Phlex\Ui\Text::addTo(\Phlex\Ui\View::addTo($webpage, ['red' => true,  'ui' => 'segment']))
    ->addParagraph('Layouts can be used to wrap your UI elements into HTML / Boilerplate');

// toolbar
$tb = \Phlex\Ui\View::addTo($webpage);

// iframe
$i = \Phlex\Ui\View::addTo($webpage, ['green' => true, 'ui' => 'segment'])->setElement('iframe')->setStyle(['width' => '100%', 'height' => '500px']);

...
$msg = \Phlex\Ui\Message::addTo($webpage, ['Virtual Page']);
...
$btn = \Phlex\Ui\Button::addTo($webpage, ['More info on Car']);
$btn->link($virtualPage->cb->getUrl() . '&p_id=Car');

$btn = \Phlex\Ui\Button::addTo($webpage, ['More info on Bike']);
...
\Phlex\Ui\Header::addTo($webpage, ['Inside Modal', 'subHeader' => 'Virtual page content can be display using JsModal Class.']);
...
\Phlex\Ui\View::addTo($webpage, ['ui' => 'hidden divider']);
$text = \Phlex\Ui\Text::addTo($webpage);
...
$frame = \Phlex\Ui\VirtualPage::addTo($webpage);

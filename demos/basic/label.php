...
\Phlex\Ui\Header::addTo($webpage, ['Labels']);
\Phlex\Ui\Label::addTo($webpage, ['Hot!']);
\Phlex\Ui\Label::addTo($webpage, ['23', 'icon' => 'mail']);
\Phlex\Ui\Label::addTo($webpage, ['new', 'iconRight' => 'delete']);

\Phlex\Ui\Label::addTo($webpage, ['Coded in PHP', 'image' => $img]);
\Phlex\Ui\Label::addTo($webpage, ['Number of lines', 'detail' => '33']);

\Phlex\Ui\Header::addTo($webpage, ['Combinations and Interraction']);
$del = \Phlex\Ui\Label::addTo($webpage, ['Zoe', 'image' => 'https://semantic-ui.com/images/avatar/small/ade.jpg', 'iconRight' => 'delete']);
$del->on('click', '.delete', $del->js()->fadeOut());

$val = isset($_GET['toggle']) && $_GET['toggle'];
$toggle = \Phlex\Ui\Label::addTo($webpage, ['icon' => 'toggle ' . ($val ? 'on' : 'off')])->set('Value: ' . $val);

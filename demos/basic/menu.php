...
$menu = \Phlex\Ui\Menu::addTo($webpage, ['vertical pointing']);
...
$menu = \Phlex\Ui\Menu::addTo($webpage, ['secondary vertical pointing']);
$menu->addItem(['Inbox', 'label' => ['123', 'teal left pointing']]);
$menu->addItem('Spam');
\Phlex\Ui\Form\Control\Input::addTo($menu->addItem(), ['placeholder' => 'Search', 'icon' => 'search'])->addClass('transparent');
$menu = \Phlex\Ui\Menu::addTo($webpage, ['vertical']);
